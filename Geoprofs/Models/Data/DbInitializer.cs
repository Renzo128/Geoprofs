...
namespace Geoprofs.Models.Data
{
    public static class DbInitializer
    {
        public static void Initialize(DB context)
        {
            ...
            new Coworker{CoworkerName="Meredith",coworkerLastname="Alonso",bsn=804842313,position=positions[2].positionId,startDate=DateTime.Parse("2002-09-01"),absence=absences[1].absenceId,vacationdays=24},
            new Coworker{CoworkerName="Arturo",coworkerLastname="Anand",bsn=885837774,position=positions[2].positionId,startDate=DateTime.Parse("2003-09-01"),absence=absences[2].absenceId,vacationdays=23},
            new Coworker{CoworkerName="Gytis",coworkerLastname="Barzdukas",bsn=615947999,position=positions[0].positionId,startDate=DateTime.Parse("2002-09-01"),absence=absences[0].absenceId,vacationdays=22},
            new Coworker{CoworkerName="Yan",coworkerLastname="Li",bsn=416644452,position=positions[1].positionId,startDate=DateTime.Parse("2002-09-01"),absence=absences[1].absenceId,vacationdays=21},
            new Coworker{CoworkerName="Peggy",coworkerLastname="Justice",bsn=098765432,position=positions[3].positionId,startDate=DateTime.Parse("2001-09-01"),absence=absences[2].absenceId,vacationdays=20},
            new Coworker{CoworkerName="Laura",coworkerLastname="Norman",bsn=865426789,position=positions[4].positionId,startDate=DateTime.Parse("2003-09-01"),absence=absences[0].absenceId,vacationdays=19},
            new Coworker{CoworkerName="Nino",coworkerLastname="Olivetto",bsn=123412389,position=positions[5].positionId,startDate=DateTime.Parse("2005-09-01"),absence=absences[1].absenceId,vacationdays=18},
            new Coworker{CoworkerName="Laura",coworkerLastname="Barzdukas",bsn=123412389,position=positions[6].positionId,startDate=DateTime.Parse("2005-09-01"),absence=absences[2].absenceId,vacationdays=17}
